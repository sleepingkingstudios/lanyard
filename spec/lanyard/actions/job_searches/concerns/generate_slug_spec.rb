...
RSpec.describe Lanyard::Actions::JobSearches::Concerns::GenerateSlug do
  ...
  example_class 'Spec::Action', Cuprum::Command do |klass|
    klass.prepend(Lanyard::Actions::JobSearches::Concerns::GenerateSlug) # rubocop:disable RSpec/DescribedClass
  ...
  describe '#call' do
    let(:command_class) { Lanyard::Models::JobSearches::GenerateSlug }
    let(:command) do
      instance_double(
