...
RSpec.describe Lanyard::Actions::Applications::Concerns::GenerateSlug do
  ...
  example_class 'Spec::Action', Cuprum::Command do |klass|
    klass.prepend(Lanyard::Actions::Applications::Concerns::GenerateSlug) # rubocop:disable RSpec/DescribedClass
  ...
  describe '#call' do
    let(:command_class) { Lanyard::Models::Applications::GenerateSlug }
    let(:command) do
      instance_double(
