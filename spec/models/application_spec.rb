...
RSpec.describe Application, type: :model do
  ...
  describe '#client?' do
    ...
    context 'when initialized with client_name: value' do
      ...
      it { expect(application.client?).to be true }
    end
  end
  ...
  describe '#contract?' do
    ...
    context 'when initialized with contract_type: "contract"' do
      ...
      it { expect(application.contract?).to be true }
    end
    ...
    context 'when initialized with contract_type: "full time"' do
      ...
      it { expect(application.contract?).to be false }
    end
  end
  ...
  describe '#hourly?' do
    ...
    context 'when initialized with compensation_type: "hourly"' do
      ...
      it { expect(application.hourly?).to be true }
    end
    ...
    context 'when initialized with compensation_type: "salaried"' do
      ...
      it { expect(application.hourly?).to be false }
    end
  end
  ...
  describe '#in_person?' do
    ...
    context 'when initialized with location_type: "hybrid"' do
      ...
      it { expect(application.in_person?).to be true }
    end
    ...
    context 'when initialized with location_type: "remote"' do
      ...
      it { expect(application.in_person?).to be false }
    end
  end
  ...
  describe '#full_time?' do
    ...
    context 'when initialized with contract_type: "contract"' do
      ...
      it { expect(application.full_time?).to be false }
    end
    ...
    context 'when initialized with contract_type: "full time"' do
      ...
      it { expect(application.full_time?).to be true }
    end
  end
  ...
  describe '#remote?' do
    ...
    context 'when initialized with location_type: "hybrid"' do
      ...
      it { expect(application.remote?).to be false }
    end
    ...
    context 'when initialized with location_type: "remote"' do
      ...
      it { expect(application.remote?).to be true }
    end
  end
  ...
  describe '#salaried?' do
    ...
    context 'when initialized with compensation_type: "hourly"' do
      ...
      it { expect(application.salaried?).to be false }
    end
    ...
    context 'when initialized with compensation_type: "salaried"' do
      ...
      it { expect(application.salaried?).to be true }
    end
  end
